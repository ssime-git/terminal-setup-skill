...
write_if_missing "$ZDOTDIR/prompt.zsh" '# Ensure starship is in PATH before this runs (e.g. eval "$(brew shellenv)" for Homebrew users)\ncommand -v starship >/dev/null 2>&1 && eval "$(starship init zsh)"\n'
